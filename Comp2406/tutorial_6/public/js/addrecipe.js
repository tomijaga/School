...
function genRandom() {
  ...
  let mealDes =
    mealDescriptors[Math.floor(Math.random() * mealDescriptors.length)];

  document.getElementById("recipename").value =
    descriptor + " " + protein + " with " + acc;
  ...
  document.getElementById("description").value =
    "A " + mealDes + " recipe using " + protein + " and " + acc;
...
function submit() {
  ...
  fetch("/recipes", {
    ...
    resp.status === 200
      ...
      : alert("Error Ocurred while adding Recipe");
